...
First note, when we call `rentrez::entrez_fetch` for multiple IDs, and turn the output into a list, we get a list whoes first element contains an entry for each record:
